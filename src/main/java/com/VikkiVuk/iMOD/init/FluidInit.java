...
public class FluidInit
{
    ...
    public static final ForgeFlowingFluid.Properties MILK_PROPERTIES = new ForgeFlowingFluid.Properties(MILK_FLUID, MILK_FLOWING, FluidAttributes.builder(MILK_STILL_RL, MILK_FLOWING_RL).density(5).luminosity(10).rarity(Rarity.RARE).sound(SoundEvents.ITEM_HONEY_BOTTLE_DRINK).overlay(MILK_OVERLAY_RL)).block(FluidInit.MILK_BLOCK).bucket(() -> ItemInitNew.chocolate_milk_bucket.get());
    public static final RegistryObject<FlowingFluidBlock> MILK_BLOCK = BlockInit.BLOCKS.register("chocolate_milk", () -> new FlowingFluidBlock(FluidInit.MILK_FLUID, Block.Properties.create(Material.WATER).doesNotBlockMovement().hardnessAndResistance(100.0f).noDrops()));
}
